...
public class AccountTransferController {
    ...
    public ResponseEntity<AccountTransfer> addBeneficiary(@PathVariable String userId, @RequestBody AccountTransfer accountTransfer) {
    ...
    public ResponseEntity<AccountTransfer> getBeneficiary(@PathVariable String userId, @PathVariable String beneficiaryId) {
    ...
    public ResponseEntity<List<AccountTransfer>> getAllBeneficiaries(@PathVariable String userId) {
    ...
    public ResponseEntity<String> deleteBeneficiary(@PathVariable String userId, @PathVariable String beneficiaryId) {
